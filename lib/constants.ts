...
// Пагинация admin-списков (products/orders) — план Фазы 5 сознательно откладывал UI под неё
// (limit: 100 без постраничной навигации), закрывается отдельно. Не CATALOG_PAGE_SIZE — таблица
// строк, не сетка карточек, число подобрано под высоту экрана без скролла на большинстве мониторов.
